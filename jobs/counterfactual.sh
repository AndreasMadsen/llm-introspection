...
do
    ...
    do
        ...
        do
            for task_config in '' 'c-persona-you e-persona-you' 'e-persona-human' 'e-implcit-target' 'e-implcit-target c-persona-you e-persona-you' 'e-implcit-target e-persona-human'
            do
